...
// Rota para mostrar opções (nova nota ou anexar)
Route::get('/compartilhar/opcoes', [CompartilharController::class, 'mostrarOpcoes'])
    ->middleware('auth')
    ->name('compartilhar.opcoes');

// Rota para salvar em nova nota
Route::post('/compartilhar/salvar-nova', [CompartilharController::class, 'salvarNovaNota'])
    ->middleware('auth')
    ->name('compartilhar.salvar-nova');

// Rota para anexar a nota existente
Route::post('/compartilhar/anexar-existente', [CompartilharController::class, 'anexarExistente'])
    ->middleware('auth')
    ->name('compartilhar.anexar-existente');
